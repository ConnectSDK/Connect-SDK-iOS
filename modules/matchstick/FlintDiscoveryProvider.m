...
#import "FlintDiscoveryProvider.h"
#import <Matchstick/Flint.h>
#import "ServiceDescription.h"
#import "FlintService.h"

@interface FlintDiscoveryProvider () <MSFKDeviceScannerListener>
{
    MSFKDeviceScanner *_deviceScanner;
...
@implementation FlintDiscoveryProvider
...
- (instancetype) init
{
    ...
    if (self)
    {
        ...
        _deviceScanner = [MSFKDeviceScanner new];
...
#pragma mark - MSFKDeviceScannerListenerDelegate
...
- (void)deviceDidComeOnline:(MSFKDevice *)device
{
    ...
    serviceDescription.serviceId = kConnectSDKFlingServiceId;
