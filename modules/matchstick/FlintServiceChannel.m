...
@implementation FlintServiceChannel
{
    __weak FlintWebAppSession *_session;
}

- (instancetype)initWithAppId:(NSString *)appId session:(FlintWebAppSession *)session
{
    self = [super initWithNamespace:@"urn:x-flint:com.connectsdk"];
